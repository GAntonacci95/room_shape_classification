...
def run():
    ...
    match = [nn_architectures.agenovese_wnfrmp0nofdrfeatAGvolRestr_R,
             nn_architectures.agenovese_wnfrmp0nofdrfeatAGvolRestr_L]

    # # VOLUME REGRESSION OVER R/L
    ...
    for c, archi in zip(classes, match):
        ...
        # dsu.show_field_distro(dfi, "volume_m3")
        dfi = dsu.select_by_scalar_field_range(dfi, "volume_m3", 100, 316.23)

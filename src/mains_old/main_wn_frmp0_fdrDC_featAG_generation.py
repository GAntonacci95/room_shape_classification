...
def run():
    ...
    # eg_fdrs.computeDC(egnoiseacqus_output_dir, {"f_s": f_s})
    egnoisefdrs_output_dir = eg_fdrs.loadDC(egnoiseacqus_output_dir, {"f_s": f_s})
    # eg_reports_fdrs.create_report(egnoisefdrs_output_dir, "fdrsDC")
    # </editor-fold>

...
def run():
    ...
    base_model_dir, latest_model_dir, latest_epoch, latest_model =\
        eg_nn.create_or_load_model(nn_architectures.gantonacci_rircutMLP, {"input_shape": input_shape,
    ...
    base_model_dir, k_model_dir, k_model = eg_nn.load_best_test_model(nn_architectures.gantonacci_rircutMLP)

...
def run():
    ...
    # eg_fdrs.computeDC(egvoiceacqus_output_dir,
    #                   {"f_s": f_s, "len_min_samps": 1600, "len_max_samps": 50000})
    egvoicefdrs_output_dir = eg_fdrs.loadDC(egvoiceacqus_output_dir,
                                            {"f_s": f_s, "len_min_samps": 1600, "len_max_samps": 50000})
    ...
    dsname = "main_vc_frmp0_fdrDC_for_leaf"

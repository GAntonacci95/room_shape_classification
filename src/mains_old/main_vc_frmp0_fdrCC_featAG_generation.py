...
def run():
    ...
    # eg_adapt.compute(egvoicefdrs_output_dir, {"len_max": Lhop})
    adapted_out_dir = eg_adapt.load(egvoicefdrs_output_dir, {"len_max": Lhop})
    ...
    # nonostante la previsione, ci mette meno
    # ricomporre X=(20K, 25, L3), class_id=(20K, 1), volume_log=(20K, 1) è fattibile ed
    # è ora caricabile in memoria senza eccessivi problemi (10.5GB ca)

...
def run():
    ...
    dsname = "main_rlh_wn_frmp0_nofdr_featAG"   # HERE "TODEL" FOR HEAT
    ...
    #     eg_nn.create_or_load_model(nn_architectures.gantonacci_rlhwnfrmp0nofdrfeatAG, model_params)
    ...
    base_model_dir, k_model_dir, k_model = eg_nn.load_best_test_model(nn_architectures.gantonacci_rlhwnfrmp0nofdrfeatAG)

...
def run():
    ...
    #     eg_nn.create_or_load_model(nn_architectures.gantonacci_vcfrmp0fdrCCfeatAG, model_params)
    ...
    base_model_dir, k_model_dir, k_model = eg_nn.load_best_test_model(nn_architectures.gantonacci_vcfrmp0fdrCCfeatAG)

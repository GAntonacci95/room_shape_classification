...
def run():
    ...
    base_model_dir, latest_model_dir, latest_epoch, latest_model =\
        eg_nn.create_or_load_model(nn_architectures.gantonacci_wnfrmp0nofdrfeatAG, {"map_shape": map_shape,
    ...
    base_model_dir, k_model_dir, k_model = eg_nn.load_best_test_model(nn_architectures.gantonacci_wnfrmp0nofdrfeatAG)

...
def run():
    ...
    # eg_3d.compute_rlh({})
    eg3d_output_dir = eg_3d.load_rlh({})
    ...
    f_s = 16000
    max_ord = 10
    n_acqus_per_room = 8     # irs/(stanza*classe) nel range dei volumi 50-1050m3
    frmp = 0
    # FIXED MATERIALS
    mds = [
    ...
    #     "n_rnd_acquisitons_per_room": n_acqus_per_room,     # each with a random material
    #     "f_s": f_s,
    #     "max_ord": max_ord
    # })
    egsetups_output_dir = eg_setups.load(eg3d_output_dir, {
        "materials_descriptors": mds,
        "n_rnd_acquisitons_per_room": n_acqus_per_room,
        "f_s": f_s,
        "max_ord": max_ord
    })
    ...
    L = 11944   # nnpreprocutils.get_len_max_of_signals_in_dir(egnoiseacqus_output_dir)
    # print("L: {}".format(L))

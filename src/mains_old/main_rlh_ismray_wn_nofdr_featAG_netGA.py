...
def run():
    ...
    dsname = "main_rlh_ismray_wn_nofdr_featAG"   # HERE "TODEL" FOR HEAT
    ...
    # dftest.to_pickle("./datasets/nn/final_datasets/TODEL.pkl")      # HERE UNA SOLA VOLTA
    del df
    ...
    #     eg_nn.create_or_load_model(nn_architectures.gantonacci_rlhismraywnnofdrfeatAG, model_params)
    ...
    base_model_dir, k_model_dir, k_model = eg_nn.load_best_test_model(nn_architectures.gantonacci_rlhismraywnnofdrfeatAG)

...
# TODO(rev_voices_sensed_o3_ray_leaf_trial): Markdown description  that will appear on the catalog page.
_DESCRIPTION = """
...
# TODO(rev_voices_sensed_o3_ray_leaf_trial): BibTeX citation
_CITATION = """
"""


class RevVoicesSensedO3RayLeafTrial(tfds.core.GeneratorBasedBuilder):
  """DatasetBuilder for rev_voices_sensed_o3_ray_leaf_trial dataset."""
  ...
  def _info(self) -> tfds.core.DatasetInfo:
    ...
    # TODO(rev_voices_sensed_o3_ray_leaf_trial): Specifies the tfds.core.DatasetInfo object
  ...
  def _split_generators(self, dl_manager: tfds.download.DownloadManager):
    ...
    # TODO(rev_voices_sensed_o3_ray_leaf_trial): Downloads the data and defines the splits
    # caricare il dataset pkl, fare split ed un po'di pre-processing
    # HATEFUL ABS PATH - THIS IS ACTUALLY o10 NOT o3
    df = p.read_pickle("/nas/home/gantonacci/Thesis/Project/pythonProject/datasets/nn/final_datasets/main_rlh_ismray_vc_nofdr_for_leaf.pkl")
  ...
  def _generate_examples(self, split: p.DataFrame):
    """Yields examples."""
    # TODO(rev_voices_sensed_o3_ray_leaf_trial): Yields (key, example) tuples from the dataset

...
# TODO(rev_voices_sensed_o10_ray_leaf_trial): Markdown description  that will appear on the catalog page.
_DESCRIPTION = """
...
# TODO(rev_voices_sensed_o10_ray_leaf_trial): BibTeX citation
_CITATION = """
"""


class RevVoicesSensedO10RayLeafTrial(tfds.core.GeneratorBasedBuilder):
  """DatasetBuilder for rev_voices_sensed_o10_ray_leaf_trial dataset."""
  ...
  def _info(self) -> tfds.core.DatasetInfo:
    ...
    # TODO(rev_voices_sensed_o10_ray_leaf_trial): Specifies the tfds.core.DatasetInfo object
    return tfds.core.DatasetInfo(
        ...
        homepage="/nas/home/gantonacci/Thesis/Project/pythonProject/datasets/nn/final_datasets/main_rlh_ismray_vc_nofdr_for_leaf.pkl",
        citation=_CITATION,
    )

  def _split_generators(self, dl_manager: tfds.download.DownloadManager):
    """Returns SplitGenerators."""
    # TODO(rev_voices_sensed_o10_ray_leaf_trial): Downloads the data and defines the splits
    ...
    # TODO(rev_voices_sensed_o10_ray_leaf_trial): Returns the Dict[split names, Iterator[Key, Example]]
    return {
  ...
  def _generate_examples(self, split: p.DataFrame):
    """Yields examples."""
    # TODO(rev_voices_sensed_o10_ray_leaf_trial): Yields (key, example) tuples from the dataset

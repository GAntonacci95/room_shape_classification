...
def run():
    ...
    Lnegligible = 53649
    L = 193346  # nnpreprocutils.get_len_max_of_signals_in_dir(egvoiceacqus_output_dir)
    L -= Lnegligible
    ...
    # eg_finalize_ds.feat_normalize(dsname, dsnamenormal)
    ...
    #                                        r"$\epsilon$",
    #                                        r"$\chi$"
    #                                    ], win_len, hop_size, "vc_featAG_normal")

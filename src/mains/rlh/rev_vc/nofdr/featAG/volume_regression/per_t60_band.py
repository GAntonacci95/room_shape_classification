...
def run():
    ...
    match = [
        nn_architectures.agenovese_ismrayvcnofdrfeatAG_tb0,
        nn_architectures.agenovese_ismrayvcnofdrfeatAG_tb2,
        nn_architectures.agenovese_ismrayvcnofdrfeatAG_tb4
    ]

...
def run():
    ...
    # x_bands = field_bands(50, 1050, 3)
    # try2
    x_bands = [[50, 300], [400, 700], [800, 1050]]

    match = [
        nn_architectures.agenovese_ismrayvcnofdrfeatAG_vb0_try2,
        nn_architectures.agenovese_ismrayvcnofdrfeatAG_vb2_try2,
        nn_architectures.agenovese_ismrayvcnofdrfeatAG_vb4_try2
    ]

    dsname = "main_rlh_ismray_vc_nofdr_featAG"
    ...
    for x_band, archi in zip(x_bands, match):
        ...
        eg_nn.train_model(latest_model, training_gen, val_gen, base_model_dir, latest_epoch, {
            "red_factor": 0.1, "red_patience": 10, "delta": 100, "early_patience": 53
        })
        # </editor-fold>

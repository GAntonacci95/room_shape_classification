...
def run():
    ...
    dsname = "main_rlh_ismray_vc_nofdr_featAG_normal"   # changed
    ...
    archi = nn_architectures.gantonacci_rlhismrayvcnofdrfeatAG_normal   # changed
    model_params = {"map_shape": map_shape, "n_classes": len(classes)}
    train_params = {"red_factor": 0.1, "red_patience": 20, "delta": 0.01, "early_patience": 203}    # changed
    # </editor-fold>

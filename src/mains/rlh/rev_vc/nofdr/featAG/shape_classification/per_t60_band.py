...
def run():
    ...
    archis = [
        # nn_architectures.gantonacci_rlhismrayvcnofdrfeatAG_normal_tb0,      # bad results, diggin'deeper...
        nn_architectures.gantonacci_rlhismrayvcnofdrfeatAG_normal_tb2,
        nn_architectures.gantonacci_rlhismrayvcnofdrfeatAG_normal_tb4
    ]

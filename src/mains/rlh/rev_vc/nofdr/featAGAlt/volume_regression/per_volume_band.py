...
def run():
    ...
    match = [
        nn_architectures.agenovese_ismrayvcnofdrfeatAG_vb0,
        nn_architectures.agenovese_ismrayvcnofdrfeatAG_vb2,
        nn_architectures.agenovese_ismrayvcnofdrfeatAG_vb4
    ]

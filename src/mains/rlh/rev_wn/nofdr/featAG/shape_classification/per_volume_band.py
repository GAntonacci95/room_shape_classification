...
def run():
    ...
    archis = [
        nn_architectures.gantonacci_rlhismraywnnofdrnetAG_vb0,
        nn_architectures.gantonacci_rlhismraywnnofdrnetAG_vb2,
        nn_architectures.gantonacci_rlhismraywnnofdrnetAG_vb4
    ]

...
def run():
    ...
    selection_field = "t60"
    bands = field_bands(0.5, 2.5, 3)[1:]
    archis = [
        # gli passo sopra in featAGAlt
        # nn_architectures.gantonacci_rlhismraywnnofdrnetAG_tb0,      # bad results, diggin'deeper...
        nn_architectures.gantonacci_rlhismraywnnofdrnetAG_tb2,
        nn_architectures.gantonacci_rlhismraywnnofdrnetAG_tb4
    ]
    ...
    for band, archi in zip(bands, archis):
        ...
        train_params = {"red_factor": 0.2, "red_patience": 10, "delta": 0.01, "early_patience": 33}
        # </editor-fold>

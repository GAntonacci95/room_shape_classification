...
def run():
    ...
    match = [
        nn_architectures.agenovese_ismraywnnofdrfeatAG_vb0,
        nn_architectures.agenovese_ismraywnnofdrfeatAG_vb2,
        nn_architectures.agenovese_ismraywnnofdrfeatAG_vb4
    ]

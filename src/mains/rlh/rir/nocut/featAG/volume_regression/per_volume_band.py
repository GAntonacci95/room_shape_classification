...
def run():
    ...
    match = [
        nn_architectures.agenovese_ismrayrirnocutfeatAG_vb0,
        nn_architectures.agenovese_ismrayrirnocutfeatAG_vb2,
        nn_architectures.agenovese_ismrayrirnocutfeatAG_vb4
    ]

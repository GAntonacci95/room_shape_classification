...
def run():
    ...
    match = [
        nn_architectures.agenovese_ismrayrirnocutfeatAG_tb0,
        nn_architectures.agenovese_ismrayrirnocutfeatAG_tb2,
        nn_architectures.agenovese_ismrayrirnocutfeatAG_tb4
    ]

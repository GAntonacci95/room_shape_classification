...
def run():
    ...
    bands = field_bands(50, 1050, 3)
    archis = [
        nn_architectures.gantonacci_rlhismrayrirnocutnetAG_vb0,
        nn_architectures.gantonacci_rlhismrayrirnocutnetAG_vb2,
        nn_architectures.gantonacci_rlhismrayrirnocutnetAG_vb4
    ]

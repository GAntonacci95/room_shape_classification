...
def run():
    ...
    selection_field = "t60"
    bands = field_bands(0.5, 2.5, 3)
    archis = [
        nn_architectures.gantonacci_rlhismrayrirnocutnetAG_tb0,
        nn_architectures.gantonacci_rlhismrayrirnocutnetAG_tb2,
        nn_architectures.gantonacci_rlhismrayrirnocutnetAG_tb4
    ]
